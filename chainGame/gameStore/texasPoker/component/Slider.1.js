...
export default class Slider extends PureComponent {
  ...
  _renderTrackImage = () => {
    var {trackImage} = this.props;

    if (!trackImage) return;

    return <Image source={trackImage}  style={{width: "100%", height: "100%"}} />;
  };

  _renderTrackShowImage = () => { 
    var {trackShowImage} = this.props;

    if (!trackShowImage) return;

    return <Image source={trackShowImage}  style={{width: "100%", height: "100%"}} />;
  };
}
